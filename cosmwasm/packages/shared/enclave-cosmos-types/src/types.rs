...
// cosmos address in > 0.40 can be any length
#[derive(PartialEq, Clone, Debug)]
pub struct CosmosAddress(pub Vec<u8>);
...
impl CosmWasmMsg {
    ...
    fn try_parse_instantiate(bytes: &[u8]) -> Result<Self, EnclaveError> {
        use cosmwasm_proto::proto::cosmwasm::msg::MsgInstantiateContract;
    ...
    fn try_parse_execute(bytes: &[u8]) -> Result<Self, EnclaveError> {
        use cosmwasm_proto::proto::cosmwasm::msg::MsgExecuteContract;
